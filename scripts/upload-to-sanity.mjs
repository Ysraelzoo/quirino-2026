...
const FINALISTAS = {
  ...
  2025: [
    ['Mejor Largometraje',              'Buffalo Kids',                                          'España',                                    'Atresmedia Cine, 4Cats Pictures, Little Big Boy, Anangu Grup, Mogambo Entertainment',                    'Pedro Solís, Juan Jesús García "Galo"'],
    ['Mejor Largometraje',              'Dispararon al pianista (They Shot the Piano Player)',    'España, Francia, Países Bajos, Portugal, Perú', 'They Shot The Piano Player, Fernando Trueba PC, Julián Piker & Fermín, Les Films d\'Ici Méditerranée, Submarine Animation, Animanostra CAM, Producciones Tondero', 'Javier Mariscal, Fernando Trueba'],
    ['Mejor Serie',                     'Jasmine & Jambo – Temporada 3',                         'España',                                    'Teidees Audiovisuals',                                                'Sílvia Cortés'],
    ['Mejor Serie',                     'Primeras – Temporada 1',                                'Chile, España',                             'Typpo Creative Lab, TV ON Producciones, Admirable Films',             'Bambú Orellana, Paloma Mora'],
    ['Mejor Serie',                     'Wow Lisa – Temporada 1',                                'Chile',                                     'Punkrobot',                                                           'Antonia Herrera, María Elisa Soto-Aguilar'],
    ['Mejor Cortometraje',              'A Menina com os Olhos Ocupados',                        'Portugal',                                  'Blablabla Media',                                                     'André Carrilho'],
    ['Mejor Cortometraje',              'Percebes',                                              'Portugal, Francia',                         'BAP Animation Studios, Ikki Films',                                   'Alexandra Ramires, Laura Gonçalves'],
    ['Mejor Cortometraje de escuela',   'Cuando llegue la inundación',                           'España',                                    'Universitat Politècnica de València',                                 'Antonio Lomas Domingo'],
    ['Mejor Cortometraje de escuela',   'Tesoro',                                                'España',                                    'Universitat Politècnica de València',                                 'Carmen Álvarez Muñoz'],
    ['Mejor Animación de Encargo',      'Cineminuto Pixelatl 2024 – Vence tus miedos',           'México',                                    'Hobby Creative Studio, Ronin Studio, Bakemono',                       'Humberto Cervera Baron'],
    ['Mejor Animación de Encargo',      'Tenemos que hablar',                                    'México',                                    'Voces Imaginarias, Fundación Freedom',                                'Mario Muñoz'],
    ['Mejor Videoclip',                 'Hero',                                                  'Brasil',                                    'Zombie Studio',                                                       'Paulo Garcia'],
    ['Mejor Videoclip',                 'Horizonte',                                             'Argentina',                                 'Rudo Company',                                                        'Pablo Roldán'],
    ['Mejor Animación de Videojuego',   'Saviorless',                                            'Cuba',                                      'Empty Head Games',                                                    ''],
    ['Mejor Animación de Videojuego',   'Shelley Manor',                                         'España',                                    'Tiny Terrors Studio – ESAT',                                          ''],
    ['Mejor Desarrollo Visual',         'Kabuki',                                                'Brasil, Francia',                           'Minamisawa Films, WAG Productions, Bruno H Castro Filmes, Amopix, Coala Filmes, Split Studio', 'Tiago Minamisawa'],
    ['Mejor Desarrollo Visual',         'A Menina com os Olhos Ocupados',                        'Portugal',                                  'Blablabla Media',                                                     'André Carrilho'],
    ['Mejor Diseño de Animación',       '47',                                                    'Brasil',                                    'Zombie Studio',                                                       'Paulo Garcia, Natalia Gouvea'],
    ['Mejor Diseño de Animación',       'Kabuki',                                                'Brasil, Francia',                           'Minamisawa Films, WAG Productions, Bruno H Castro Filmes, Amopix, Coala Filmes, Split Studio', 'Tiago Minamisawa'],
    ['Mejor Diseño de Sonido y Música', 'El Arca de Noé. Una Aventura Musical',                  'Brasil, India',                             'Gullane, VideoFilmes, Symbiosys, Globo Filmes, Telecine',             'Sérgio Machado, Alois Di Leo'],
    ['Mejor Diseño de Sonido y Música', 'A Menina com os Olhos Ocupados',                        'Portugal',                                  'Blablabla Media',                                                     'André Carrilho'],
  ],
};
